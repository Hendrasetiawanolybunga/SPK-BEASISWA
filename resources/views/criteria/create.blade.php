    ...
    <form action="{{ route('criteria.store') }}" method="POST" id="criteriaForm">
        ...
        <div class="row g-4">
            <div class="col-md-6">
                ...
                <input type="text" name="name" class="form-control" placeholder="Contoh: Prestasi Akademik" required>
            </div>
            ...
            <div class="col-md-12">
                ...
                <div class="d-flex align-items-center gap-3">
                    <input type="range" step="0.01" min="0" max="1" value="0" id="weightSlider" class="form-range w-50">
                    <input type="number" name="weight" step="0.01" min="0" max="1" id="weightInput" class="form-control w-25" readonly>
                </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    form.addEventListener('submit', function (e) {
        ...
        if ((existingTotal + newWeight) > 1.001) {
            e.preventDefault();
            alert(`Total bobot akan melebihi 1! Silakan kurangi bobot atau hapus kriteria lain terlebih dahulu.`);
        }
    });
});
</script>
