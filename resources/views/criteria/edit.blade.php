        ...
        <div class="row g-4">
            ...
            <div class="col-md-12">
                ...
                <div class="d-flex align-items-center gap-3">
                    <input type="range" step="0.01" min="0" max="1" value="{{ $criteria->weight }}" id="weightSlider" class="form-range w-50">
                    <input type="number" name="weight" step="0.01" min="0" max="1" id="weightInput" value="{{ $criteria->weight }}" class="form-control w-25" required>
                </div>
