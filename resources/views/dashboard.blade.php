...
<style>
    ...
    .card, .btn, .list-group-item {
        transition: all 0.3s ease-in-out; /* Smooth transitions for all interactive elements */
    }

    /* Dashboard Header Section */
    .dashboard-header {
        background: linear-gradient(135deg, #007bff 0%, #0056b3 100%); /* Deeper, more vibrant gradient */
        color: white;
        padding: 3rem 0; /* More vertical padding */
        border-radius: 1rem; /* More rounded corners */
        margin-bottom: 2.5rem; /* More space below header */
        box-shadow: 0 12px 24px rgba(0, 0, 0, 0.25); /* Stronger, softer shadow */
        position: relative;
        overflow: hidden;
        animation: fadeInDown 0.8s ease-out; /* Subtle fade-in from top */
    }
    ...
    .dashboard-header::before {
        ...
        width: 200%;
        height: 200%;
        background: rgba(255, 255, 255, 0.08); /* More visible overlay */
        transform: rotate(45deg);
        pointer-events: none;
    }

    .dashboard-header h3 {
        font-size: 3.2rem; /* Even larger font for strong impact */
        margin-bottom: 0.75rem;
        text-shadow: 2px 2px 5px rgba(0, 0, 0, 0.3); /* More defined text shadow */
    ...
    .dashboard-header .fa-3x {
        font-size: 4em; /* Very large icon for hero section */
    ...
    .card-stat {
        ...
        overflow: hidden;
        box-shadow: 0 6px 12px rgba(0, 0, 0, 0.1); /* Initial subtle shadow */
        animation: fadeInUp 0.8s ease-out forwards; /* Fade in from bottom */
        opacity: 0; /* Start invisible for animation */
    }
    .card-stat:nth-child(1) { animation-delay: 0.2s; } /* Stagger animation */
    .card-stat:nth-child(2) { animation-delay: 0.4s; }
    .card-stat:nth-child(3) { animation-delay: 0.6s; }


    .card-stat:hover {
        transform: translateY(-12px) scale(1.03); /* More pronounced lift and enlarge */
        box-shadow: 0 20px 40px rgba(0, 0, 0, 0.3); /* Deeper, more dramatic shadow */
    }
    ...
    .card-stat .fa-3x {
        font-size: 3.5em; /* Larger icons within cards */
    }
    ...
    .card-quick-links .list-group-item i {
        width: 30px; /* Wider fixed width for icons */
        text-align: center;
    ...
    .card-info-system .card-header {
        background: linear-gradient(45deg, #6c757d 0%, #495057 100%); /* Darker gradient header */
        color: white;
        border-bottom: none;
    ...
    .btn-logout-dashboard {
        ...
        box-shadow: 0 6px 12px rgba(220, 53, 69, 0.3); /* Red shadow */
    }
    ...
    .btn-logout-dashboard:hover {
        ...
        box-shadow: 0 10px 20px rgba(220, 53, 69, 0.4); /* Stronger shadow on hover */
    }
...
<div class="container mt-5">
    ...
    <div class="dashboard-header text-center py-5 px-4 mb-5">
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-12 col-md-auto">
                ...
                <p class="lead">Halo, {{ Auth::guard('admin')->user()->username }}! Mari kelola sistem beasiswa Anda.</p>
            </div>
        </div>
    ...
    <div class="row">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col">
                                ...
                                <div class="h3 mb-0 fw-bold text-gray-800" data-target="{{ $totalAlternatives }}">0</div> {{-- Data target untuk counter --}}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col">
                                ...
                                <div class="h3 mb-0 fw-bold text-gray-800" data-target="{{ $totalCriterias }}">0</div> {{-- Data target untuk counter --}}
                            </div>
                        </div>
                    </div>
                    <div class="card-footer bg-transparent border-0 text-end">
                        <span class="text-success small fw-bold">Lihat Detail <i class="fas fa-arrow-right ms-1"></i></span>
                    </div>
                </div>
            </a>
        </div>
        ...
        <div class="col-md-12 col-lg-4 mb-4">
            <div class="card card-quick-links shadow-sm h-100 border-start border-info border-4">
                <div class="card-body">
                    ...
                    <div class="list-group list-group-flush"> {{-- Menggunakan list-group-flush untuk borderless --}}
                        <a href="{{ route('admin.profile.edit') }}" class="list-group-item list-group-item-action d-flex align-items-center">
                            <i class="fas fa-user-edit me-3 text-secondary"></i> Kelola Profil Admin
                        </a>
                        <a href="{{ route('admin.password.change.form') }}" class="list-group-item list-group-item-action d-flex align-items-center">
    ...
    <div class="row mt-4">
        <div class="col-12">
            <div class="card card-info-system shadow-sm">
                ...
                <div class="card-body">
                    <p class="mb-3">Sistem Pendukung Keputusan (SPK) Beasiswa ini dirancang untuk membantu dalam proses pengambilan keputusan pemberian beasiswa berdasarkan kriteria yang telah ditentukan.</p>
                    <p class="mb-0">Pastikan data alternatif dan kriteria selalu diperbarui untuk hasil perhitungan yang akurat dan relevan. Gunakan menu navigasi di atas untuk mengakses berbagai fitur.</p>
                </div>
            </div>
        </div>
    </div>
