...
<head>
    ...
    <style>
        body {
            ...
            /* Changed to column to place marquee at bottom */
            align-items: center;
            ...
            overflow: hidden;
            position: relative;
            /* For absolute positioning of marquee */
        }
        ...
        .password-input-group {
            position: relative;
            /* Needed for absolute positioning of toggle icon */
        }
        ...
        .running-text-container {
            ...
            z-index: 0;
            /* Ensure it's behind the login card */
        }
...
<body>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6 col-xl-5 m-0 p-3">
                <div class="login-card m-0">
    ...
    <div class="running-text-container">
        <div class="running-text-content">
            "Jika anda ingin berjalan cepat, maka jalanlah sendiri, tapi jika anda ingin berjalan jauh, maka jalanlah
            bersama-sama, salam titik koma <strong>;</strong> - TCP"
        </div>
    </div>
