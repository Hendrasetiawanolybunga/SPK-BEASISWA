...
<div class="container mt-4">
    ...
    <form action="{{ route('alternatives.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="name" id="name" class="form-control" placeholder="Contoh: Ahmad Rofiudin" required>
        </div>
        ...
        <div class="row g-4">
            @foreach($criterias as $criteria)
                ...
                <div class="col-md-6">
                    <label class="form-label fw-semibold">{{ $criteria->name }} <span class="text-muted">({{ ucfirst($criteria->type) }})</span></label>
