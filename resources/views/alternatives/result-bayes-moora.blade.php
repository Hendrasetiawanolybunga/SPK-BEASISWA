...
<div class="container mt-4">
    ...
    @if ($totalAlternatives === 0)
        <div class="alert alert-warning text-center">
            <strong>⚠️ Tidak ada data alternatif untuk ditampilkan.</strong> Silakan tambahkan data alternatif dan skor kriteria.
        </div>
    @else
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-success mt-4 text-center">
                        ...
                        <p class="fs-5 mb-0">{{ $mooraRankings[0]['alt']->name }}<br>
                            <span class="text-muted">Skor MOORA Tertinggi: {{ number_format($mooraRankings[0]['score'], 4) }}</span>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingOne">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                            <i class="fas fa-times-circle me-2 text-danger"></i> Lihat Alternatif TIDAK LAYAK (Hasil Bayes)
                        </button>
                    </h2>
                    <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionTidakLayak">
