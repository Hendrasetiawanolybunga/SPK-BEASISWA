                ...
                <div class="card border-0 bg-light shadow-sm rounded-3 overflow-hidden">
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            <h1 class="display-6 fw-bold"><i class="fas fa-brain me-2 text-primary"></i>Hasil Analisis
                                Beasiswa</h1>
                        ...
                        <div class="d-flex flex-wrap mt-3 gap-3">
                            ...
                            <div class="p-3 bg-success bg-opacity-10 rounded-3 flex-grow-1">
                                    ...
                                    <div class="col-md-4">
                                        <div class="card border-0 shadow-sm rounded-3 overflow-hidden h-100">
                                            <div class="card-body p-4">
                                                ...
                                                <p class="text-muted small mb-0">Kandidat yang memenuhi kriteria kelayakan
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card border-0 shadow-sm rounded-3 overflow-hidden mb-4">
                                        <div class="card-header bg-primary bg-opacity-10 border-0 py-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <h2 class="h4 fw-bold text-primary mb-0">Tahap 1: Penyaringan Kandidat
                                                    dengan Naive Bayes</h2>
                                            </div>
                                        </div>
                                        <div class="card-body p-4">
                                            <p class="text-muted mb-4">Metode Naive Bayes menganalisis data historis untuk
                                            ...
                                            @if (count($bayesResults) > 0)
                                                <div class="table-responsive rounded">
                                                    <table class="table table-hover align-middle mb-0">
                                                        <thead class="bg-light">
                                                            <tr>
                                                                <th class="border-0"><i
                                                                        class="fas fa-user text-primary me-2"></i>Nama
                                                                    Kandidat</th>
                                                                <th class="border-0 text-center"><i
                                                                        class="fas fa-check-circle text-success me-2"></i>Probabilitas
                                                                    Layak</th>
                                                                <th class="border-0 text-center"><i
                                                                        class="fas fa-times-circle text-danger me-2"></i>Probabilitas
                                                                    Tidak Layak
                                                                </th>
                                                                <th class="border-0 text-center"><i
                                                                        class="fas fa-award me-2"></i>Hasil Penyaringan
                                                                </th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                                        ...
                                                                        @else
                                                                            <span
                                                                                class="badge bg-danger bg-opacity-10 text-danger px-3 py-2 rounded-pill fw-medium"><i
                                                                                    class="fas fa-times-circle me-1"></i>Tidak
                                                                                Layak</span>
                                                                        @endif
                                                                    </td>
                                                                </tr>
                                                ...
                                                <div class="mt-5 mb-4">
                                                    ...
                                                    <p class="text-muted mb-4">Berikut adalah rincian perhitungan
                                                        probabilitas untuk setiap kandidat
                                                    ...
                                                    @foreach ($bayesProses as $index => $process)
                                                        <div
                                                            ...
                                                            <h2 class="accordion-header"
                                                                id="headingBayes{{ $index }}">
                                                                <button class="accordion-button collapsed" type="button"
                                                                    data-bs-toggle="collapse"
                                                                    data-bs-target="#collapseBayes{{ $index }}"
                                                                    aria-expanded="false"
                                                                    aria-controls="collapseBayes{{ $index }}">
                                                                    <div class="d-flex align-items-center w-100">
                                                                        ...
                                                                        <div class="flex-grow-1">
                                                                            <span
                                                                                class="fw-medium">{{ $process['alternative'] }}</span>
                                                                            <span
                                                                        ...
                                                                        <div class="d-none d-md-flex align-items-center">
                                                                            <div class="me-4">
                                                                                <small
                                                                                    class="text-muted d-block">Probabilitas
                                                                                    Layak</small>
                                                                                <span
                                                                ...
                                                                <div class="accordion-body bg-white">
                                                                    <div class="alert alert-light border-0 rounded-3 mb-4">
                                                                        <h5 class="fw-bold mb-3"><i
                                                                                class="fas fa-info-circle text-primary me-2"></i>Bagaimana
                                                                            Naive
                                                                            Bayes Bekerja?</h5>
                                                                        <p class="mb-0">Metode ini menghitung
                                                                            probabilitas setiap kriteria
                                                                            berdasarkan data historis, kemudian
                                                                            mengkombinasikannya untuk menentukan
                                                                            kelayakan kandidat.</p>
                                                                    </div>

                                                                    <div class="table-responsive rounded">
                                                                        <table
                                                                            class="table table-sm table-hover mb-3 align-middle">
                                                                            <thead class="bg-light">
                                                                                <tr>
                                                                                    <th class="border-0"><i
                                                                                            class="fas fa-tag text-primary me-1"></i>
                                                                                        Kriteria</th>
                                                                                    <th class="border-0 text-center"><i
                                                                                            class="fas fa-list-ol text-primary me-1"></i>
                                                                                        Nilai
                                                                                    </th>
                                                                                    <th class="border-0 text-center"><i
                                                                    ...
                                                                    <div class="row g-3 mt-2">
                                                                        <div class="col-md-6">
                                                                            <div
                                                                                class="card h-100 border-0 bg-success bg-opacity-10 rounded-3">
                                                                                <div class="card-body p-3">
                                                                                    ...
                                                                                    <p
                                                                                        class="h4 fw-bold text-success mb-0">
                                                                                        {{ number_format($process['final_prob_layak'], 6) }}
                                                                                    </p>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <div
                                                                                class="card h-100 border-0 bg-danger bg-opacity-10 rounded-3">
                                                                                <div class="card-body p-3">
                                                                                    <div
                                                                                        class="d-flex align-items-center mb-2">
                                                                                        <i
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <div>
                                                                                <h5 class="fw-bold mb-0">Kesimpulan:
                                                                                    {{ $process['keputusan'] }}
                                                                                </h5>
                                                                                <p class="mb-0 mt-1">
                                                                                    @if ($process['keputusan'] === 'LAYAK')
                                                                                        Kandidat ini memenuhi kriteria
                                                                                        kelayakan berdasarkan
                                                                                        perhitungan probabilitas.
                                                                                    @else
                                                                                        Kandidat ini belum memenuhi kriteria
                                                                                        kelayakan berdasarkan
                                                                                        perhitungan probabilitas.
                                                                                    @endif
                                                                                </p>
                                            ...
                                            @else
                                                <p class="text-muted fs-5"><i class="fas fa-info-circle me-2"></i>Belum
                                                    ada data hasil Naive
                                                    Bayes.</p>
                                            @endif
                                </section>
                                ...
                                <section>
                                    <div
                                        class="card border-0 bg-success bg-opacity-10 shadow-sm rounded-3 overflow-hidden mb-4">
                                        <div class="card-body p-4">
                                            <h2 class="fw-bold mb-3"><i
                                                    class="fas fa-sort-amount-up me-2 text-success"></i>Ranking <span
                                                    class="text-success">MOORA</span></h2>
                                            <p class="lead mb-0">Metode <strong>Multi-Objective Optimization on the basis
                                                    of Ratio Analysis
                                                    (MOORA)</strong> digunakan untuk mengurutkan kandidat yang telah
                                                dinyatakan layak oleh metode
                                                Naive Bayes. Metode ini mempertimbangkan kriteria benefit (semakin tinggi
                                                semakin baik) dan cost
                                                (semakin rendah semakin baik) untuk menghasilkan peringkat akhir.</p>
                                        </div>
                                    </div>
                                    ...
                                    @if (count($mooraRankings) > 0)
                                        <div class="card border-0 shadow-sm rounded-3 overflow-hidden mb-4">
                                            <div class="card-header bg-dark text-white py-3">
                                                <h5 class="mb-0"><i class="fas fa-trophy me-2"></i>Peringkat Kandidat
                                                    Beasiswa (MOORA)</h5>
                                            </div>
                                            <div class="card-body p-0">
                                                <div class="table-responsive">
                                                    <table class="table table-hover align-middle mb-0">
                                                        <thead class="bg-light">
                                                            <tr>
                                                                <th class="py-3"><i class="fas fa-medal me-1"></i>
                                                                    Ranking</th>
                                                                <th class="py-3"><i class="fas fa-user me-1"></i>
                                                                    Alternative</th>
                                                                <th class="py-3"><i
                                                                        class="fas fa-plus-circle text-success me-1"></i>
                                                                    Benefit
                                                                    Score</th>
                                                                <th class="py-3"><i
                                                                        class="fas fa-minus-circle text-danger me-1"></i>
                                                                    Cost Score
                                                                </th>
                                                                <th class="py-3"><i
                                                                        class="fas fa-equals text-primary me-1"></i> Final
                                                                    Score
                                                                </th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            ...
                                                            @foreach ($mooraRankings as $ranking)
                                                                @php
                                                                    ...
                                                                    $finalScores =
                                                                        $mooraProses['final_scores'][$altName] ?? null;
                                                                @endphp
                                        ...
                                        <div class="card border-0 shadow-sm rounded-3 overflow-hidden mb-4">
                                            <div class="card-header bg-success bg-opacity-10 py-3">
                                                <h3 class="mb-0 fw-bold"><i class="fas fa-book-reader me-2"></i>Detail
                                                    Proses Perhitungan MOORA
                                                </h3>
                                                <p class="text-muted mt-2 mb-0">Berikut adalah langkah-langkah perhitungan
                                                    metode MOORA untuk
                                                ...
                                                <div class="alert alert-info">
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="mb-0">Metode MOORA menggunakan beberapa tahapan
                                                                perhitungan:</p>
                                                            <ol class="mb-0 mt-2">
                                                                <li><strong>Raw Matrix</strong> - Nilai asli dari setiap
                                                                    alternatif untuk setiap
                                                                    kriteria</li>
                                                                <li><strong>Denominators</strong> - Akar dari jumlah kuadrat
                                                                    nilai untuk setiap
                                                                    kriteria</li>
                                                                <li><strong>Normalized Matrix</strong> - Nilai yang telah
                                                                    dinormalisasi (dibagi
                                                                    dengan denominator)</li>
                                                                <li><strong>Final Scores</strong> - Skor akhir yang
                                                                    menentukan peringkat (benefit -
                                                                    cost)</li>
                                                            </ol>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <h2 class="accordion-header" id="headingRawMatrix">
                                                            <button class="accordion-button collapsed" type="button"
                                                                ...
                                                                <strong>Langkah 1: Raw Matrix</strong> - Nilai Asli Setiap
                                                                Alternatif
                                                            </button>
                                                        </h2>
                                                        <div id="collapseRawMatrix" class="accordion-collapse collapse"
                                                            aria-labelledby="headingRawMatrix"
                                                            data-bs-parent="#mooraProcessAccordion">
                                                            <div class="accordion-body bg-light">
                                                                <p class="text-muted mb-3">Matriks ini berisi nilai asli
                                                                ...
                                                                @php
                                                                    ...
                                                                    if (!empty($mooraProses['raw_matrix'])) {
                                                                        $firstAlt = array_key_first(
                                                                            $mooraProses['raw_matrix'],
                                                                        );
                                                                        $criteriaCount = count(
                                                                            $mooraProses['raw_matrix'][$firstAlt],
                                                                        );
            ...
            $criteriaNames[] =
                'Kriteria ' . ($i + 1);
                                                                ...
                                                                <x-matrix-table title="Raw Matrix"
                                                                    ...
                                                                    :matrix="$mooraProses['raw_matrix']" :criteria_names="$criteriaNames" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <h2 class="accordion-header" id="headingDenominators">
                                                            <button class="accordion-button collapsed" type="button"
                                                                data-bs-toggle="collapse"
                                                                data-bs-target="#collapseDenominators"
                                                                aria-expanded="false"
                                                                aria-controls="collapseDenominators">
                                                                <i class="fas fa-calculator me-2 text-success"></i>
                                                                <strong>Langkah 2: Denominators</strong> - Akar dari Jumlah
                                                                Kuadrat
                                                            </button>
                                                        </h2>
                                                        <div id="collapseDenominators" class="accordion-collapse collapse"
                                                            aria-labelledby="headingDenominators"
                                                            data-bs-parent="#mooraProcessAccordion">
                                                            <div class="accordion-body bg-light">
                                                                <p class="text-muted mb-3">Denominator untuk setiap
                                                                    kriteria dihitung dengan
                                                                    mengambil akar kuadrat dari jumlah kuadrat nilai semua
                                                                    alternatif untuk kriteria
                                                                    tersebut.</p>

                                                                <x-denominators-table title="Denominators"
                                                                    description="Akar dari jumlah kuadrat nilai untuk setiap kriteria"
                                                                    :denominators="$mooraProses['denominators']" :criteria_names="$criteriaNames" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <h2 class="accordion-header" id="headingNormalizedMatrix">
                                                            <button class="accordion-button collapsed" type="button"
                                                                data-bs-toggle="collapse"
                                                                data-bs-target="#collapseNormalizedMatrix"
                                                                aria-expanded="false"
                                                                aria-controls="collapseNormalizedMatrix">
                                                                <i class="fas fa-balance-scale me-2 text-warning"></i>
                                                                <strong>Langkah 3: Normalized Matrix</strong> - Nilai yang
                                                                Telah Dinormalisasi
                                                            </button>
                                                        </h2>
                                                        <div id="collapseNormalizedMatrix"
                                                            class="accordion-collapse collapse"
                                                            aria-labelledby="headingNormalizedMatrix"
                                                            data-bs-parent="#mooraProcessAccordion">
                                                            <div class="accordion-body bg-light">
                                                                <p class="text-muted mb-3">Matriks ini berisi nilai yang
                                                                    telah dinormalisasi dengan
                                                                    membagi nilai asli dengan denominator untuk setiap
                                                                    kriteria.</p>
                                                                ...
                                                                <x-matrix-table title="Normalized Matrix"
                                                                    ...
                                                                    :matrix="$mooraProses['normalized_matrix']" :criteria_names="$criteriaNames" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <h2 class="accordion-header" id="headingFinalScores">
                                                            <button class="accordion-button collapsed" type="button"
                                                                data-bs-toggle="collapse"
                                                                data-bs-target="#collapseFinalScores"
                                                                aria-expanded="false" aria-controls="collapseFinalScores">
                                                                <i class="fas fa-star me-2 text-danger"></i>
                                                                <strong>Langkah 4: Final Scores</strong> - Skor Akhir dan
                                                                Peringkat
                                                            </button>
                                                        </h2>
                                                        <div id="collapseFinalScores" class="accordion-collapse collapse"
                                                            aria-labelledby="headingFinalScores"
                                                            data-bs-parent="#mooraProcessAccordion">
                                                            <div class="accordion-body bg-light">
                                                                <p class="text-muted mb-3">Skor akhir dihitung dengan
                                                                    mengurangkan jumlah nilai
                                                                    kriteria cost dari jumlah nilai kriteria benefit.
                                                                    Semakin tinggi skor akhir,
                                                                    semakin baik peringkat alternatif.</p>

                                                                <x-final-scores-table title="Final Scores"
                                                                    description="Skor akhir yang menentukan peringkat alternatif"
                                                                    :scores="$mooraProses['final_scores']" method="moora" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card border-0 shadow-sm rounded-3 overflow-hidden mb-4">
                                            <div class="card-body p-4 text-center">
                                                <div class="py-5">
                                                    ...
                                                    <p class="text-muted mb-0">Belum ada data untuk perhitungan MOORA, atau
                                                        semua alternatif tidak
