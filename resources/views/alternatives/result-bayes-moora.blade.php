    ...
    <div class="container my-4">
        ...
        <section>
            <div class="card border-0 bg-success bg-opacity-10 shadow-sm rounded-3 overflow-hidden mb-4">
                <div class="card-body p-4">
                    <h2 class="fw-bold mb-3"><i class="fas fa-sort-amount-up me-2 text-success"></i>Ranking <span
                            class="text-success">MOORA</span></h2>
                    <p class="lead mb-0">Metode <strong>Multi-Objective Optimization on the basis of Ratio Analysis
                            (MOORA)</strong> digunakan untuk mengurutkan kandidat yang telah dinyatakan layak oleh metode
                        Naive Bayes. Metode ini mempertimbangkan kriteria benefit (semakin tinggi semakin baik) dan cost
            ...
            @if (count($mooraRankings) > 0)
                <div class="card border-0 shadow-sm rounded-3 overflow-hidden mb-4">
                    <div class="card-header bg-dark text-white py-3">
                        <h5 class="mb-0"><i class="fas fa-trophy me-2"></i>Peringkat Kandidat Beasiswa (MOORA)</h5>
                    </div>
                            ...
                            <table class="table table-hover align-middle mb-0">
                                <thead class="bg-light">
                                    <tr>
                                        ...
                                        <th class="py-3"><i class="fas fa-plus-circle text-success me-1"></i> Benefit
                                            Score</th>
                                        <th class="py-3"><i class="fas fa-minus-circle text-danger me-1"></i> Cost Score
                                        </th>
                                        <th class="py-3"><i class="fas fa-equals text-primary me-1"></i> Final Score
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                ...
                <div class="card border-0 shadow-sm rounded-3 overflow-hidden mb-4">
                    <div class="card-header bg-success bg-opacity-10 py-3">
                        <h3 class="mb-0 fw-bold"><i class="fas fa-book-reader me-2"></i>Detail Proses Perhitungan MOORA
                        </h3>
                        <p class="text-muted mt-2 mb-0">Berikut adalah langkah-langkah perhitungan metode MOORA untuk
                                ...
                                <div>
                                    ...
                                    <ol class="mb-0 mt-2">
                                        <li><strong>Raw Matrix</strong> - Nilai asli dari setiap alternatif untuk setiap
                                            kriteria</li>
                                        <li><strong>Denominators</strong> - Akar dari jumlah kuadrat nilai untuk setiap
                                            kriteria</li>
                                        <li><strong>Normalized Matrix</strong> - Nilai yang telah dinormalisasi (dibagi
                                            dengan denominator)</li>
                                        <li><strong>Final Scores</strong> - Skor akhir yang menentukan peringkat (benefit -
                                            cost)</li>
                                    </ol>
                                </div>
                            </div>
                        ...
                        <div class="accordion mt-4" id="mooraProcessAccordion">
                            <div class="accordion-item border-0 shadow-sm mb-3 rounded-3 overflow-hidden">
                                ...
                                <div id="collapseRawMatrix" class="accordion-collapse collapse"
                                    aria-labelledby="headingRawMatrix" data-bs-parent="#mooraProcessAccordion">
            ...
            $criteriaNames[] = 'Kriteria ' . ($i + 1);
                            ...
                            <div class="accordion-item border-0 shadow-sm mb-3 rounded-3 overflow-hidden">
                                <h2 class="accordion-header" id="headingDenominators">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#collapseDenominators" aria-expanded="false"
                                ...
                                <div id="collapseDenominators" class="accordion-collapse collapse"
                                    aria-labelledby="headingDenominators" data-bs-parent="#mooraProcessAccordion">
                                    <div class="accordion-body bg-light">
                                        <p class="text-muted mb-3">Denominator untuk setiap kriteria dihitung dengan
                                            mengambil akar kuadrat dari jumlah kuadrat nilai semua alternatif untuk kriteria
                                            tersebut.</p>
                            ...
                            <div class="accordion-item border-0 shadow-sm mb-3 rounded-3 overflow-hidden">
                                ...
                                <div id="collapseNormalizedMatrix" class="accordion-collapse collapse"
                                    aria-labelledby="headingNormalizedMatrix" data-bs-parent="#mooraProcessAccordion">
                                    <div class="accordion-body bg-light">
                                        <p class="text-muted mb-3">Matriks ini berisi nilai yang telah dinormalisasi dengan
                                            membagi nilai asli dengan denominator untuk setiap kriteria.</p>
                            ...
                            <div class="accordion-item border-0 shadow-sm mb-3 rounded-3 overflow-hidden">
                                ...
                                <div id="collapseFinalScores" class="accordion-collapse collapse"
                                    aria-labelledby="headingFinalScores" data-bs-parent="#mooraProcessAccordion">
                                    <div class="accordion-body bg-light">
                                        <p class="text-muted mb-3">Skor akhir dihitung dengan mengurangkan jumlah nilai
                                            kriteria cost dari jumlah nilai kriteria benefit. Semakin tinggi skor akhir,
                                            semakin baik peringkat alternatif.</p>

                                        <x-final-scores-table title="Final Scores"
                                            description="Skor akhir yang menentukan peringkat alternatif" :scores="$mooraProses['final_scores']"
                                            method="moora" />
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card border-0 shadow-sm rounded-3 overflow-hidden mb-4">
                    <div class="card-body p-4 text-center">
                        <div class="py-5">
                            ...
                            <p class="text-muted mb-0">Belum ada data untuk perhitungan MOORA, atau semua alternatif tidak
