                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex flex-wrap mt-3 gap-3">
                            ...
                            <div class="p-3 bg-warning bg-opacity-10 rounded-3 flex-grow-1">
                                ...
                                <section>
                                    <div
                                        class="card border-0 bg-warning bg-opacity-10 shadow-sm rounded-3 overflow-hidden mb-4">
                                        <div class="card-body p-4">
                                            <h2 class="fw-bold mb-3"><i
                                                    class="fas fa-sort-amount-down me-2 text-warning"></i>Ranking <span
                                                    class="text-warning">MAIRCA</span></h2>
                                            <p class="lead mb-0">Metode <strong>Multi-Attributive Ideal-Real Comparative
                                                    Analysis (MAIRCA)</strong>
                                                mengurutkan alternatif yang telah dinyatakan layak oleh Naive Bayes. Semakin
                                                kecil nilai deviasi,
                                                        ...
                                                        <thead class="bg-light">
                                                            <tr>
                                                                ...
                                                                <th class="py-3"><i class="fas fa-user me-1"></i>
                                                                    Alternative</th>
                                                                <th class="py-3"><i
                                                                        class="fas fa-chart-line text-primary me-1"></i>
                                                                    Final
                                                                    Deviation</th>
                                                            </tr>
                                                        </thead>
                                                            ...
                                                            @foreach ($maircaRankings as $ranking)
                                                                ...
                                                                <tr class="{{ $rankNo <= 3 ? 'table-warning' : '' }}">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <small class="text-muted">Semakin kecil nilai,
                                                                            semakin baik
                                                                            peringkat</small>
                                                                    </td>
                                                                </tr>
                                                ...
                                                <div class="alert alert-info">
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="mb-0">Metode MAIRCA menggunakan beberapa tahapan
                                                                perhitungan:</p>
                                                            <ol class="mb-0 mt-2">
                                                                ...
                                                                <li><strong>Ideal Weights</strong> - Bobot ideal untuk
                                                                    setiap kriteria</li>
                                                                <li><strong>Final Scores</strong> - Skor akhir yang
                                                                    menentukan peringkat (hasil
                                                ...
                                                <div class="accordion" id="maircaProcessAccordion">
                                                    <div
                                                        ...
                                                        <div id="collapseRawMatrix" class="accordion-collapse collapse"
                                                            ...
                                                            data-bs-parent="#maircaProcessAccordion">
                                                                ...
                                                                @php
                                                                    ...
                                                                    if (!empty($maircaProses['raw_matrix'])) {
                                                                        $firstAlt = array_key_first(
                                                                            $maircaProses['raw_matrix'],
                                                                        );
                                                                        $criteriaCount = count(
                                                                            $maircaProses['raw_matrix'][$firstAlt],
                                                                        );
                ...
                'Kriteria ' . ($i + 1);
                                                    ...
                                                    <div
                                                        ...
                                                        <h2 class="accordion-header" id="headingNormalizedMatrix">
                                                            <button class="accordion-button collapsed" type="button"
                                                                ...
                                                                <strong>Langkah 2: Normalized Matrix</strong> - Nilai yang
                                                                Telah Dinormalisasi
                                                            </button>
                                                        </h2>
                                                        <div id="collapseNormalizedMatrix"
                                                            ...
                                                            data-bs-parent="#maircaProcessAccordion">
                                                            <div class="accordion-body bg-light">
                                                                <p class="text-muted mb-3">Matriks yang telah dinormalisasi
                                                                    untuk menyamakan skala
                                                    ...
                                                    <div
                                                        ...
                                                        <h2 class="accordion-header" id="headingNormalizedMatrix">
                                                            <button class="accordion-button collapsed" type="button"
                                                                data-bs-toggle="collapse"
                                                                data-bs-target="#collapseIdealWeights"
                                                                aria-expanded="false"
                                                                aria-controls="collapseIdealWeights">
                                                                <i class="fas fa-weight-hanging me-2 text-success"></i>
                                                                <strong>Langkah 3: Ideal Weights</strong> - Bobot Ideal
                                                                untuk Setiap Kriteria
                                                            </button>
                                                        </h2>
                                                        <div id="collapseIdealWeights" class="accordion-collapse collapse"
                                                            aria-labelledby="headingIdealWeights"
                                                            data-bs-parent="#maircaProcessAccordion">
                                                            <div class="accordion-body bg-light">
                                                                <p class="text-muted mb-3">Bobot ideal yang digunakan untuk
                                                                    menghitung deviasi dari
                                                                    setiap alternatif.</p>
                                                    ...
                                                    <div
                                                        ...
                                                        <h2 class="accordion-header" id="headingFinalScores">
                                                            <button class="accordion-button collapsed" type="button"
                                                                ...
                                                                <strong>Langkah 4: Final Scores (Deviasi)</strong> - Skor
                                                                Akhir dan Peringkat
                                                            </button>
                                                        </h2>
                                                        <div id="collapseFinalScores" class="accordion-collapse collapse"
                                                            ...
                                                            data-bs-parent="#maircaProcessAccordion">
                                                            <div class="accordion-body bg-light">
                                                                <p class="text-muted mb-3">Skor akhir yang menunjukkan
                                                                    deviasi setiap alternatif
                                                                    dari nilai ideal. Semakin kecil nilai deviasi, semakin
                                                                    baik peringkat
                                                                    alternatif.</p>

                                                                <x-final-scores-table title="Final Scores (Deviasi)"
                                                                    description="Skor akhir yang menentukan peringkat alternatif"
                                                                    :scores="$maircaProses['final_scores']" method="mairca" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card border-0 shadow-sm rounded-3 overflow-hidden mb-4">
                                            <div class="card-body p-4 text-center">
                                                <div class="py-5">
                                                    ...
                                                    <p class="text-muted mb-0">Belum ada data untuk perhitungan MAIRCA,
                                                        atau semua alternatif tidak
