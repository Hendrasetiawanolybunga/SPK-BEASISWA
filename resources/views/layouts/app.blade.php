...
<head>
    ...
    <style>
        ...
        main {
            flex: 1;
            /* Memberikan padding-top agar konten tidak tertutup navbar */
            padding-top: 75px; 
        }

        /* Menambahkan gaya untuk navbar dengan opasitas dan rounded */
        .navbar-custom {
            border-radius: 1rem; /* Sudut membulat */
            opacity: 0.8; /* Opasitas 60% */
            left: 50%;
        ...
        /* Kelas untuk container utama yang non-fluid, rounded, dan shadow */
        .main-container {
            border-radius: 1rem;
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm px-5 fixed-top navbar-custom">
